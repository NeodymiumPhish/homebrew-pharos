cask "pharos" do
  ...
  url "https://github.com/NeodymiumPhish/Pharos/releases/download/v#{version}/Pharos_#{version}_x64.dmg"
  name "Pharos"
  desc "High-performance PostgreSQL client with Liquid Glass UI"
